                      ...
                      child: DecoratedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              ...
                              textStyle: textTheme.actionTextStyle,
                              backgroundColor: Colors.transparent,
                              shadowColor: Colors.transparent),
                          // color: Colors.transparent,
                          // padding: EdgeInsets.zero,
                          // cupertino: (_, __) =>
                          //     CupertinoTextButtonData(originalStyle: false),
                          child: ConstrainedBox(
                            constraints:
                                ...
                                Align(
                                  ...
                                  child: Builder(builder: (context) {
                                    final color = DefaultTextStyle.of(context)
                                        .style
                                        .color;
                                    return Icon(CupertinoIcons.hand_thumbsup,
                                        color: color);
                                  }),
                                ),
                                const Center(child: Text('Confirm')),
                        ...
                        child: PlatformTextButton(
                          ...
                          child: DefaultTextStyle(
                            style: textTheme.actionTextStyle
                                .apply(color: CupertinoColors.destructiveRed),
                            child: ConstrainedBox(
                              constraints:
                                  const BoxConstraints(maxWidth: 250 / 2),
                              child: Stack(
