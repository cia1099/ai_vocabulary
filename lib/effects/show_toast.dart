        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: const CupertinoDynamicColor.withBrightness(
                    color: Color(0xBF1E1E1E), darkColor: Color(0xCCF2F2F2))
                .resolveFrom(context),
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text.rich(
                  TextSpan(text: "You're familiar with ", children: [
                    TextSpan(
                        text: word,
...
class _AnimatedFadeInOut extends StatefulWidget {
  ...
  const _AnimatedFadeInOut(
      {super.key, required this.child, this.duration = Durations.short2});
