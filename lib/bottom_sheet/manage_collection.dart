...
class ManageCollectionSheet extends StatefulWidget {
  final int wordID;
  const ManageCollectionSheet({super.key, required this.wordID});
          ...
          child: DraggableScrollableSheet(
            ...
            builder:
                (context, scrollController) => PlatformWidgetBuilder(
                  ...
                  cupertino:
                      (_, child, __) => CupertinoPopupSurface(child: child!),
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: ReorderableListView.builder(
                          ...
                          itemBuilder:
                              (context, index) => itemBuilder(marks[index]),
