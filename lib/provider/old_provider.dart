...
class OldProvider {
  ...
  static OldProvider? _instance;
  OldProvider._internal() {
    _init();
  }
  static OldProvider get instance => _instance ??= OldProvider._internal();
  factory OldProvider() => instance;
